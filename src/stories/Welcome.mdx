...
3. **Set up assets (if building for gov.uk):**
   Follow the [guide to import font and image assets](https://frontend.design-system.service.gov.uk/import-font-and-images-assets/). Assets _must_ be served from `<YOUR_SITE_URL>/assets`.
